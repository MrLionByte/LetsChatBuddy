...
const ChatInterface = ({ currentUser, activeChat, messages, onSendMessage, onBackToChats }) => {
    ...
    <div className="flex flex-col h-[70vh] md:h-[60vh] -m-6">
      <div className="bg-dark-400/50 backdrop-blur-sm border-b border-dark-400/50 p-4 flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-white/60 text-sm">{activeChat.status === 'online' ? 'Online' : `Last seen ${activeChat.lastActive}`}</p>
        </div>
      </div>
